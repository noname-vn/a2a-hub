...
var v0_3_exports = {};
__export(v0_3_exports, {
  A2A_LEGACY_PROTOCOL_VERSION: () => A2A_LEGACY_PROTOCOL_VERSION,
  LEGACY_HTTP_EXTENSION_HEADER: () => LEGACY_HTTP_EXTENSION_HEADER,
  LEGACY_JSON_CONTENT_TYPE: () => LEGACY_JSON_CONTENT_TYPE,
  LEGACY_METHOD_GET_AUTHENTICATED_EXTENDED_CARD: () => LEGACY_METHOD_GET_AUTHENTICATED_EXTENDED_CARD,
  LEGACY_METHOD_MESSAGE_SEND: () => LEGACY_METHOD_MESSAGE_SEND,
  LEGACY_METHOD_MESSAGE_STREAM: () => LEGACY_METHOD_MESSAGE_STREAM,
  LEGACY_METHOD_PUSH_NOTIFICATION_CONFIG_DELETE: () => LEGACY_METHOD_PUSH_NOTIFICATION_CONFIG_DELETE,
  LEGACY_METHOD_PUSH_NOTIFICATION_CONFIG_GET: () => LEGACY_METHOD_PUSH_NOTIFICATION_CONFIG_GET,
  LEGACY_METHOD_PUSH_NOTIFICATION_CONFIG_LIST: () => LEGACY_METHOD_PUSH_NOTIFICATION_CONFIG_LIST,
  LEGACY_METHOD_PUSH_NOTIFICATION_CONFIG_SET: () => LEGACY_METHOD_PUSH_NOTIFICATION_CONFIG_SET,
  LEGACY_METHOD_TASKS_CANCEL: () => LEGACY_METHOD_TASKS_CANCEL,
  LEGACY_METHOD_TASKS_GET: () => LEGACY_METHOD_TASKS_GET,
  LEGACY_METHOD_TASKS_RESUBSCRIBE: () => LEGACY_METHOD_TASKS_RESUBSCRIBE,
  duplicateInterfacesForLegacy: () => duplicateInterfacesForLegacy,
  isLegacyJsonRpcMethod: () => isLegacyJsonRpcMethod,
  isV1JsonRpcMethod: () => isV1JsonRpcMethod,
  legacyGrpcToLegacyJsonRpcMethod: () => legacyGrpcToLegacyJsonRpcMethod,
  legacyGrpcToV1Method: () => legacyGrpcToV1Method,
  legacyJsonRpcToLegacyGrpcMethod: () => legacyJsonRpcToLegacyGrpcMethod,
  legacyJsonRpcToV1Method: () => legacyJsonRpcToV1Method,
  v1MethodToLegacyGrpc: () => v1MethodToLegacyGrpc,
  v1MethodToLegacyJsonRpc: () => v1MethodToLegacyJsonRpc
});
module.exports = __toCommonJS(v0_3_exports);
...
var lookup = (table, method, direction) => {
  const mapped = table[method];
  if (mapped === void 0) {
    throw A2AError2.invalidRequest(`Unknown ${direction} method: "${method}"`);
  }
  return mapped;
};
var lookupFromV1 = (table, method, legacyTransport) => {
  const mapped = table[method];
  if (mapped !== void 0) return mapped;
  if (V1_METHODS_WITHOUT_LEGACY_EQUIVALENT.has(method)) {
    throw A2AError2.unsupportedOperation(
      `v1.0 method "${method}" has no equivalent in v0.3 ${legacyTransport}`
    );
  }
  throw A2AError2.invalidRequest(`Unknown v1.0 method: "${method}"`);
};
function legacyJsonRpcToV1Method(method) {
...
function duplicateInterfacesForLegacy(interfaces, bindings) {
  const source = interfaces ?? [];
  const result = structuredClone(source);
  for (const binding of bindings) {
    const hasLegacy = source.some(
      (intf) => intf.protocolBinding === binding && (!intf.protocolVersion || isLegacyVersion(intf.protocolVersion))
    );
