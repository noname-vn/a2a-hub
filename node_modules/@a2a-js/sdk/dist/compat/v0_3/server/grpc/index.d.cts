...
interface LegacyGrpcServiceOptions {
 ...
 * ```
 */
declare function legacyGrpcService(options: LegacyGrpcServiceOptions): A2AServiceServer;

export { A2AServiceService as LegacyA2AService, type LegacyGrpcServiceOptions, legacyGrpcService };
