...
__export(grpc_exports, {
  LegacyA2AService: () => A2AServiceService,
  legacyGrpcService: () => legacyGrpcService
});
...
var GetAgentCardRequest2 = {
  encode(_, writer = new import_wire8.BinaryWriter()) {
    return writer;
  },
  decode(input, length) {
    const reader = input instanceof import_wire8.BinaryReader ? input : new import_wire8.BinaryReader(input);
...
var A2AServiceClient = (0, import_grpc_js.makeGenericClientConstructor)(
  A2AServiceService,
  "a2a.v1.A2AService"
);
