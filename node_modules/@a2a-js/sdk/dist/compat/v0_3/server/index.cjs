...
__export(server_exports, {
  LegacyA2AError: () => A2AError2,
  LegacyJsonRpcTransportHandler: () => LegacyJsonRpcTransportHandler,
  LegacyRestTransportHandler: () => LegacyRestTransportHandler,
  V03PushNotificationSerializer: () => V03PushNotificationSerializer,
  createLegacyAwarePushNotificationSender: () => createLegacyAwarePushNotificationSender,
  toLegacyHTTPError: () => toLegacyHTTPError
});
...
var V1PushNotificationSerializer = class {
  serialize(streamResponse, _task) {
    return {
...
var DefaultPushNotificationSender = class {
  ...
  async send(streamResponse, context, task) {
  ...
  async _dispatchNotification(streamResponse, storedConfig, taskId, task) {
