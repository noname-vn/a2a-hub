...
var A2AServiceClient = (0, import_grpc_js.makeGenericClientConstructor)(A2AServiceService, "lf.a2a.v1.A2AService");
...
var import_wire12 = require("@bufbuild/protobuf/wire");
var import_grpc_js2 = require("@grpc/grpc-js");

// src/compat/v0_3/grpc/pb/google/protobuf/empty.ts
var import_wire9 = require("@bufbuild/protobuf/wire");
function createBaseEmpty2() {
  return {};
}
var Empty2 = {
  encode(_, writer = new import_wire9.BinaryWriter()) {
    return writer;
  },
  decode(input, length) {
    const reader = input instanceof import_wire9.BinaryReader ? input : new import_wire9.BinaryReader(input);
    const end = length === void 0 ? reader.len : reader.pos + length;
...
var import_wire10 = require("@bufbuild/protobuf/wire");
function createBaseStruct2() {
  return { fields: {} };
}
var Struct2 = {
  encode(message, writer = new import_wire10.BinaryWriter()) {
    globalThis.Object.entries(message.fields).forEach(([key, value]) => {
      if (value !== void 0) {
  ...
  decode(input, length) {
    const reader = input instanceof import_wire10.BinaryReader ? input : new import_wire10.BinaryReader(input);
    const end = length === void 0 ? reader.len : reader.pos + length;
...
var import_wire11 = require("@bufbuild/protobuf/wire");
function createBaseTimestamp2() {
  return { seconds: 0, nanos: 0 };
}
var Timestamp2 = {
  encode(message, writer = new import_wire11.BinaryWriter()) {
    if (message.seconds !== 0) {
      writer.uint32(8).int64(message.seconds);
    }
    if (message.nanos !== 0) {
  ...
  decode(input, length) {
    const reader = input instanceof import_wire11.BinaryReader ? input : new import_wire11.BinaryReader(input);
    const end = length === void 0 ? reader.len : reader.pos + length;
...
var SendMessageConfiguration2 = {
  encode(message, writer = new import_wire12.BinaryWriter()) {
    for (const v of message.acceptedOutputModes) {
      writer.uint32(10).string(v);
    }
  ...
  decode(input, length) {
    const reader = input instanceof import_wire12.BinaryReader ? input : new import_wire12.BinaryReader(input);
    const end = length === void 0 ? reader.len : reader.pos + length;
...
var GetAgentCardRequest = {
  encode(_, writer = new import_wire12.BinaryWriter()) {
    return writer;
  },
  decode(input, length) {
    const reader = input instanceof import_wire12.BinaryReader ? input : new import_wire12.BinaryReader(input);
...
var A2AServiceClient2 = (0, import_grpc_js2.makeGenericClientConstructor)(
  A2AServiceService2,
  "a2a.v1.A2AService"
);
