...
function buildGrpcErrorMetadata(Metadata3, error) {
...
function grpcService(options) {
  ...
  const wrapUnaryWithConverter = async (call, callback, handler, converter) => {
    try {
  ...
  const wrapUnary = async (call, callback, handler) => {
    return wrapUnaryWithConverter(call, callback, handler, (res) => res);
  };
  const wrapStreaming = async (call, handler) => {
    try {
      const context = await _buildContext(
        call,
        options.userBuilder,
  ...
  return {
    ...
    listTaskPushNotificationConfigs(call, callback) {
      return wrapUnary(
        call,
        callback,
    ...
    getExtendedAgentCard(call, callback) {
      return wrapUnary(
        call,
        callback,
        (params, context) => requestHandler.getAuthenticatedExtendedAgentCard(params, context)
      );
    },
...
var _buildContext = async (call, userBuilder, requestHandler, contextBuilder) => {
  ...
  const tenant = call.request?.tenant;
